...
export function BackToPortfolio() {
  return (
    ...
    <a
      ...
      className="fixed bottom-24 left-4 z-50 inline-flex items-center gap-1.5 rounded-full border border-gray-200 bg-white/90 px-3 py-1.5 text-xs font-medium text-gray-600 shadow-md backdrop-blur transition-colors duration-200 ease-out hover:border-gray-300 hover:text-gray-900"
    >
